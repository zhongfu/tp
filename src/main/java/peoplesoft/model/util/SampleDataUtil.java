...
public class SampleDataUtil {
    public static Person[] getSamplePersons() {
        return new Person[] {
            new Person("1", new Name("Nicole Tan"), new Phone("99338558"), new Email("nicole@stffhub.org"),
                new Address("1 Tech Drive, S138572"),
                getTagSet("Intern", "Aircon")),
            new Person("2", new Name("Kavya Singh"), new Phone("96736637"), new Email("kavya@stffhub.org"),
                new Address("2 Orchard Turn, S238801"),
                getTagSet("Senior", "Electrician")),
            new Person("3", new Name("Ethan Lee"), new Phone("91031282"), new Email("ethan@stffhub.org"),
                new Address("10 Anson Road, S079903"),
                getTagSet("Appliances")),
            new Person("4", new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@stffhub.org"),
                new Address("Blk 47 Tampines Street 20, #17-35"),
                getTagSet("Painting")),
            new Person("5", new Name("Arjun Khatau"), new Phone("80445044"), new Email("arjun@stffhub.org"),
